...
import { useDailyQuests }  from '@/features/quests/hooks'
...
export default function HomePage() {
  ...
  const { quests, completeQuest, completing } = useDailyQuests()
      ...
      <div className="relative px-4 pt-5 pb-6 overflow-hidden"
        ...
        <div className="rounded-2xl p-4 mb-4 relative overflow-hidden"
          ...
          <div className="flex items-start justify-between mb-4">
            <div>
              <p className="font-display text-[10px] font-bold tracking-[0.2em] mb-1"
        ...
        <div className="grid grid-cols-3 gap-2">
          {[
            {
              icon: '🔥',
              value: `${profile?.streakCurrent ?? 0}d`,
              label: 'Streak',
              color: '#F59E0B',
            ...
            {
              icon: '⭐',
              value: formatNumber(profile?.xpEarnedToday ?? 0),
              label: 'Heute XP',
              color: '#A855F7',
            ...
            {
              icon: '⚡',
              value: `${energy.current}/100`,
              label: 'Energie',
              color: energy.current < 20 ? '#F43F5E' : '#06B6D4',
              glow:  energy.current < 20 ? 'rgba(244,63,94,0.3)' : 'rgba(6,182,212,0.3)',
            },
          ...
          <div className="mb-4 h-1 rounded-full overflow-hidden"
            ...
            <div className="h-full rounded-full transition-all duration-700"
              style={{
                ...
                boxShadow: allDone ? '0 0 8px rgba(16,185,129,0.6)' : '0 0 8px rgba(168,85,247,0.5)',
              }} />
          </div>
        )}
