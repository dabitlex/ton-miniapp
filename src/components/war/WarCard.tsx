      ...
      {war.state === 'live' && (
        <>
          <div className="war-plate war-rise" style={{ padding: '16px 16px 18px',
            background: 'linear-gradient(155deg,rgba(124,58,237,.20) 0%,rgba(15,10,30,.4) 45%,rgba(190,18,60,.16) 100%), linear-gradient(180deg,rgba(255,255,255,.06),rgba(255,255,255,.02))' }}>
            <Rivets />
            ...
            <div className="flex items-center justify-between mb-3" style={{ padding: '0 2px' }}>
              <div className="flex flex-col items-center gap-2" style={{ width: 118 }}>
                ...
                <span style={{ ...fd, fontSize: 23, color: '#C4B5FD',
                  textShadow: '0 0 20px rgba(167,139,250,.6)' }}>
            ...
            <p className="text-center mb-3" style={{ fontSize: 9, letterSpacing: '.16em',
              ...
              XP PRO KRIEGER · {war.myClan.memberCount} VS {war.rival.memberCount}
            </p>

            <BeamClash frontline={war.frontline} />
            <div className="flex justify-between" style={{ ...fd, fontSize: 10.5, padding: '7px 10px 0' }}>
              <span style={{ color: '#C4B5FD' }}>{Math.round(war.frontline * 100)} %</span>
          ...
          <div className="war-plate flex items-center gap-3" style={{ padding: '13px 16px' }}>
            <span style={{ fontSize: 19, filter: 'drop-shadow(0 0 8px rgba(167,139,250,.6))' }}>🎯</span>
            <div className="flex-1">
              <p style={{ ...fd, fontSize: 11 }}>DEIN KRIEGSBEITRAG HEUTE</p>
            ...
            <div className="text-right">
              <p style={{ ...fd, fontSize: 15, color: '#C4B5FD' }}>{formatNumber(war.myContribution.today)}</p>
      ...
      {war.state === 'idle' && (
        <div className="war-plate war-rise text-center" style={{ padding: '22px 18px' }}>
          ...
          <div className="w-14 h-14 rounded-2xl mx-auto mb-3 flex items-center justify-center"
            ...
            <Swords size={26} style={{ color: 'var(--violet-bright)' }} />
          </div>
                ...
                <div className="flex items-center gap-3 py-2.5">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px]" style={{ color: 'var(--text-muted)' }}>
                      {formatNumber(h.myPerCapita)} : {formatNumber(h.rivalPerCapita)} XP/Krieger
                    </p>
                  </div>
